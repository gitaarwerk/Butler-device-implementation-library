...
namespace Framework\Devices\Mediaserver;


class Mediaserver extends \Framework\Devices\Device
{
	private $_url;
	private $_contents;
	private $_dataType;
	...
	*/
	...
	{
		$this->_listings = new \Framework\Devices\Mediaserver\Contents\LibrarySections($path);
